...
const FLAT_NUMBER_PATTERN = /^[A-Z]-\d{1,5}$/
...
export default function RequestRelocationPage() {
  ...
  const handleSubmit = async (e) => {
    ...
    if (!FLAT_NUMBER_PATTERN.test(form.claimedFlatNumber)) {
            ...
            <div className="row mb-3">
              <div className="col-8">
                ...
                <input className="form-control" placeholder="B-205" value={form.claimedFlatNumber}
                  onChange={e => setForm({ ...form, claimedFlatNumber: e.target.value.toUpperCase() })} required />
                <div className="form-text">Format: one capital letter, a hyphen, then up to 5 digits (e.g. B-205).</div>
              </div>
              <div className="col-4">
